...
class GoogleSheetTools():
    ...
    def append(self, value_range_body):
        ...
        request = self.sheet.values().append(spreadsheetId=SPREADSHEET_ID, range=RANGE_NAME, valueInputOption='USER_ENTERED', body=value_range_body)
